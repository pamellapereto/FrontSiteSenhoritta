            ...
            <div className="container py-5 my-5">
                <div className="row">
                    <div className="col-md-6">
                        <h1 className="fw-bold mb-4 txtTitulo">Sobre</h1>
                        ...
                        <NavLink to="/contact" className="btn btn-outline-dark px-3">Entre em contato</NavLink>
                    </div>
                    <div className="col-md-6 d-flex justify-content-center" style={{marginTop: "57px"}}>
                        <img src="/assets/loja.jpg" alt="Loja física" height="400px" width="400px" />
                    </div>
                </div>
            </div>
        </div>
